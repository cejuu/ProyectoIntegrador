...
public class EventsWindow extends JFrame{
	...
	public void initialize() {
		...
		panel_1_1_1_3.setBounds(61, 160, 185, 307);
		panel.add(panel_1_1_1_3);

		JLabel lblNewLabel_1 = new JLabel("Torneo de Pádel");
		lblNewLabel_1.setBackground(Color.PINK);
		lblNewLabel_1.setBounds(41, 166, 111, 16);
		panel_1_1_1_3.add(lblNewLabel_1);
		...
		panel_1_1_1_3.add(btnNewButton);

		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3
				.setIcon(new ImageIcon(EventsWindow.class.getResource("/imagenes/sports-tools_53876-138077.jpeg")));
		lblNewLabel_3.setBounds(6, 6, 173, 147);
		panel_1_1_1_3.add(lblNewLabel_3);
		...
		panel_1_1_1_3_1.setBorder(new LineBorder(new Color(255, 153, 153), 4, true));
		panel_1_1_1_3_1.setBackground(Color.WHITE);
		panel_1_1_1_3_1.setBounds(305, 160, 185, 307);
		panel.add(panel_1_1_1_3_1);

		JLabel lblNewLabel_1_1 = new JLabel("Partido de Fútbol");
		lblNewLabel_1_1.setBackground(Color.PINK);
		lblNewLabel_1_1.setBounds(41, 166, 111, 16);
		panel_1_1_1_3_1.add(lblNewLabel_1_1);
		...
		btnNewButton_1.setBounds(35, 249, 117, 29);
		panel_1_1_1_3_1.add(btnNewButton_1);

		JLabel lblNewLabel_3_1 = new JLabel("New label");
		lblNewLabel_3_1
				.setIcon(new ImageIcon(EventsWindow.class.getResource("/imagenes/sports-tools_53876-138077.jpeg")));
		lblNewLabel_3_1.setBounds(6, 6, 173, 147);
		panel_1_1_1_3_1.add(lblNewLabel_3_1);

		JPanel panel_1_1_1_3_2 = new JPanel();
		panel_1_1_1_3_2.setLayout(null);
		panel_1_1_1_3_2.setBorder(new LineBorder(new Color(255, 153, 153), 4, true));
		panel_1_1_1_3_2.setBackground(Color.WHITE);
		panel_1_1_1_3_2.setBounds(545, 160, 185, 307);
		panel.add(panel_1_1_1_3_2);

		JLabel lblNewLabel_1_2 = new JLabel("Partido de Tenis");
		lblNewLabel_1_2.setBackground(Color.PINK);
		lblNewLabel_1_2.setBounds(41, 166, 111, 16);
		panel_1_1_1_3_2.add(lblNewLabel_1_2);
		...
		panel_1_1_1_3_2.add(btnNewButton_2);
