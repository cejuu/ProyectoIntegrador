...
public class PantallaInicio extends JFrame{
	...
	public void initialize() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(PantallaInicio.class.getResource("/imagenes/Sin_titulo.png")));
		...
		btnProfile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.cambioPantalla(2,3);
			}
		});
		btnProfile.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/Perfil (2).png")));
		...
		btnFriends.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/personas (1).png")));
		btnFriends.setBounds(813, 1, 51, 51);
		desktopPane.add(btnFriends);
		
		btnFriends.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.cambioPantalla(2,4);
			}
		});
		...
		btnHome.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/Sin_titulo2 (1).png")));
		...
		btnDeportes.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				controlador.cambioPantalla(2,8);
			}
		});
		...
		lblNewLabel_2.setBounds(42, 50, 109, 13);
		...
		lblNewLabel_2_1.setBounds(42, 71, 99, 13);
		...
		lblNewLabel_2_2.setBounds(42, 94, 109, 13);
		...
		lblNewLabel_2_2_1.setBounds(42, 117, 109, 13);
		...
		lblNewLabel_2_2_1_1.setBounds(42, 140, 109, 13);
		...
		lblNewLabel_2_2_1_1_1.setBounds(42, 163, 109, 13);
		...
		lblVoleyIcon_1.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/baseball-alt-free-icon-font_1.png")));
		...
		lblNewLabel_1_1.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon_1_5.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/unknown (2) (2).png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon_1_4_1.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/raquet-free-icon-font.png")));
		...
		lblNewLabel_1_1_1.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon_1_4.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/football-free-icon-font.png")));
		...
		lblNewLabel_1_1_1_1.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon_1_4_2.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/basketball-free-icon-font_1.png")));
		...
		lblNewLabel_1_1_1_1_1.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/volleyball-free-icon-font.png")));
		...
		lblNewLabel_1_1_1_1_5.setIcon(new ImageIcon(PantallaInicio.class.getResource("/imagenes/next (1).png")));
