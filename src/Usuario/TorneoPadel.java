...
public class TorneoPadel extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TorneoPadel window = new TorneoPadel();
	...
	public void initialize() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(TorneoPadel.class.getResource("/imagenes/Sin_titulo.png")));
		...
		btnProfile.setIcon(new ImageIcon(TorneoPadel.class.getResource("/imagenes/Perfil (2).png")));
		...
		btnFriends.setIcon(new ImageIcon(TorneoPadel.class.getResource("/imagenes/personas (1).png")));
		...
		btnHome.setIcon(new ImageIcon(TorneoPadel.class.getResource("/imagenes/Sin_titulo2 (1).png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(TorneoPadel.class.getResource("/imagenes/undo-alt-free-icon-font.png")));
