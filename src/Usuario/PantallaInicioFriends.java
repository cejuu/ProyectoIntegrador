...
import java.sql.*;
public class PantallaInicioFriends extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PantallaInicioFriends window = new PantallaInicioFriends();
	...
	public void initialize() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(PantallaInicioFriends.class.getResource("/imagenes/Sin_titulo.png")));
		...
		panel_1_1.setBounds(632, 55, 230, 296);
		getContentPane().add(panel_1_1);
		
		JLabel lblNombre = new JLabel("Amigos");
		lblNombre.setForeground(Color.WHITE);
		lblNombre.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblNombre.setBounds(10, 10, 169, 37);
		panel_1_1.add(lblNombre);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(20, 57, 200, 37);
		panel_1_1.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/user-free-icon-font_1.png")));
		lblNewLabel_2.setBounds(10, 4, 30, 30);
		panel_1.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Mar\u00EDa Martinez");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_3.setBounds(50, 4, 140, 30);
		panel_1.add(lblNewLabel_3);
		
		JPanel panel_1_2 = new JPanel();
		panel_1_2.setBounds(20, 106, 200, 37);
		panel_1_1.add(panel_1_2);
		panel_1_2.setLayout(null);
		
		JLabel lblNewLabel_2_1 = new JLabel("");
		lblNewLabel_2_1.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/user-free-icon-font_1.png")));
		lblNewLabel_2_1.setBounds(10, 4, 30, 30);
		panel_1_2.add(lblNewLabel_2_1);
		
		JLabel lblNewLabel_3_1 = new JLabel("Alejandro Garc\u00EDa");
		lblNewLabel_3_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_3_1.setBounds(50, 4, 140, 30);
		panel_1_2.add(lblNewLabel_3_1);
		
		JPanel panel_1_3 = new JPanel();
		panel_1_3.setBounds(20, 155, 200, 37);
		panel_1_1.add(panel_1_3);
		panel_1_3.setLayout(null);
		
		JLabel lblNewLabel_2_2 = new JLabel("");
		lblNewLabel_2_2.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/user-free-icon-font_1.png")));
		lblNewLabel_2_2.setBounds(10, 4, 30, 30);
		panel_1_3.add(lblNewLabel_2_2);
		
		JLabel lblNewLabel_3_2 = new JLabel("Pablo L\u00F3pez");
		lblNewLabel_3_2.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_3_2.setBounds(50, 4, 140, 30);
		panel_1_3.add(lblNewLabel_3_2);
		
		JPanel panel_1_2_1 = new JPanel();
		panel_1_2_1.setBounds(20, 204, 200, 37);
		panel_1_1.add(panel_1_2_1);
		panel_1_2_1.setLayout(null);
		
		JLabel lblNewLabel_2_3 = new JLabel("");
		lblNewLabel_2_3.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/user-free-icon-font_1.png")));
		lblNewLabel_2_3.setBounds(10, 4, 30, 30);
		panel_1_2_1.add(lblNewLabel_2_3);
		
		JLabel lblNewLabel_3_3 = new JLabel("Juan Albarez");
		lblNewLabel_3_3.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_3_3.setBounds(50, 4, 140, 30);
		panel_1_2_1.add(lblNewLabel_3_3);
		
		JPanel panel_1_4 = new JPanel();
		panel_1_4.setBounds(20, 251, 200, 37);
		panel_1_1.add(panel_1_4);
		panel_1_4.setLayout(null);
		
		JLabel lblNewLabel_2_4 = new JLabel("");
		lblNewLabel_2_4.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/user-free-icon-font_1.png")));
		lblNewLabel_2_4.setBounds(10, 4, 30, 30);
		panel_1_4.add(lblNewLabel_2_4);
		
		JLabel lblNewLabel_3_4 = new JLabel("Ana G\u00F3mez");
		lblNewLabel_3_4.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_3_4.setBounds(50, 4, 140, 30);
		...
		btnProfile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.cambioPantalla(4,3);
			}
		});
		btnProfile.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/Perfil (2).png")));
		...
		btnFriends.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.cambioPantalla(4,2);
			}
		});
		btnFriends.setBackground(new Color(0, 0, 0, 0));
		btnFriends.setOpaque(false);
		btnFriends.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/personas (1).png")));
		...
		btnHome.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/Sin_titulo2 (1).png")));
		...
		btnDeportes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.cambioPantalla(4,8);
			}
		});
		...
		lblNewLabel_1_2.setBounds(42, 10, 109, 30);
		dsktpMisEventos.add(lblNewLabel_1_2);
		
		JLabel lblNewLabel_2_5 = new JLabel("Baloncesto 10/06/22");
		lblNewLabel_2_5.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblNewLabel_2_5.setBounds(42, 50, 109, 13);
		dsktpMisEventos.add(lblNewLabel_2_5);
		
		JLabel lblNewLabel_2_1_1 = new JLabel("F\u00FAtbol 11/06/22");
		lblNewLabel_2_1_1.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblNewLabel_2_1_1.setBounds(42, 71, 99, 13);
		...
		lblNewLabel_2_2_1.setBounds(42, 94, 109, 13);
		...
		lblNewLabel_2_2_1_1.setBounds(42, 117, 109, 13);
		...
		lblNewLabel_2_2_1_1_1.setBounds(42, 140, 109, 13);
		...
		lblNewLabel_2_2_1_1_1_1.setBounds(42, 163, 109, 13);
		...
		lblVoleyIcon_1.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/baseball-alt-free-icon-font_1.png")));
		...
		lblNewLabel_1_1.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon_1_5.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/unknown (2) (2).png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon_1_4_1.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/raquet-free-icon-font.png")));
		...
		lblNewLabel_1_1_1.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon_1_4.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/football-free-icon-font.png")));
		...
		lblNewLabel_1_1_1_1.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon_1_4_2.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/basketball-free-icon-font_1.png")));
		...
		lblNewLabel_1_1_1_1_1.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/next (1).png")));
		...
		lblVoleyIcon.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/volleyball-free-icon-font.png")));
		...
		lblNewLabel_1_1_1_1_5.setIcon(new ImageIcon(PantallaInicioFriends.class.getResource("/imagenes/next (1).png")));
